# CentralTok
CentralTok is a tiktok for students in the High School Central, Just for Students. Just fork the project, and then play, Below this message explains how to do that.
...
- LanSchools Air (Working on, not secure yet)
- Securly
- Hapara Highlights
- GoGuardan
